...
# X_train_K, x_test_K, Y_train_K, y_test_K = train_test_split(training_X_K, entropy, test_size=0.5)
...
# plt.legend(loc = "best")
# plt.xlabel('Epoch')
# plt.ylabel('Loss (MeanSquaredError Loss)')
# plt.title("MeanSquaredError Loss vs Epochs; Split = %.2f" %(split))
# plt.show()

print("Training Loss: ", np.mean(training_loss)*100)
print("Test Loss: ", np.mean(test_loss)*100)
print("Size of model: ", model.count_params())